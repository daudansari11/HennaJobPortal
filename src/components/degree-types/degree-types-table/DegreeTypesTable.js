...
const DegreeTypesTable = ({data ,handleDelete}) => {
  return (
    <>
              ...
              data.map((item) => {
                return (
                  <tr key={item.id} role="row" className="odd">
                    ...
                    <td>
                      <span dir="ltr">{item?.degreelevel_id?.degree_level}</span>
                    </td>
                    <td>
                      <span dir="ltr">{item?.degree_type}</span>
                    </td>
                        ...
                        <ul className="dropdown-menu">
                          <li>
                            <Link
                              ...
                              to={`/admin/create-degree-type/${item._id}`}
                            >
